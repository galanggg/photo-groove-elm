						...
						if (_v1.a.b) {
							...
							return A2(
								...
								A2(
									...
									A2($elm$random$Random$uniform, firstPhoto, otherPhoto)));
						} else {
...
var $author$project$PhotoGroove$ClickedSurprise = {$: 'ClickedSurprise'};
...
var $author$project$PhotoGroove$viewLoaded = F3(
	function (photos, selectedImage, chosenSize) {
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$PhotoGroove$ClickedSurprise)
					]),
				_List_fromArray(
					[
				...
				A2(
					$elm$core$List$map,
					$author$project$PhotoGroove$viewThumbnail(selectedImage),
					photos)),
				A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$src($author$project$PhotoGroove$urlPrefix + ('large/' + selectedImage))
					]),
				_List_Nil)
			]);
	});
	...
	return A2(
		...
		function () {
			...
			switch (_v0.$) {
				case 'Loaded':
					var photos = _v0.a;
					var selectedImage = _v0.b;
					return A3($author$project$PhotoGroove$viewLoaded, photos, selectedImage, model.chosenSize);
				case 'Loading':
					return _List_Nil;
				default:
